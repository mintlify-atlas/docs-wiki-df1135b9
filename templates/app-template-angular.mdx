---
title: "Angular SPA Companion Template for ABP Solutions"
sidebarTitle: "App (Angular)"
description: "Walkthrough of templates/app/angular/ — standalone Angular SPA with provideAbpCore, provideAbpOAuth, route lazy-loading, and environment-driven endpoints."
---
...
`templates/app/angular/package.json` is the source of truth for which ABP Angular packages a generated app installs. Eight `@abp/ng.*` libraries (account, components, core, identity, oauth, setting-management, tenant-management) and the LeptonX theme libraries make up the ABP surface:
