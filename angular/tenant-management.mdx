...
This means custom object-extension fields declared in the C# `OneTimeRunner` automatically light up the Angular table and form **and** can be further customised via the prop contributors. See the [extensible UI](/aspnetcore/extending-entities) backend guide for the C# side.
