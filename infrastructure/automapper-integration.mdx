---
title: "AutoMapper integration: profiles, validation and IMapperAccessor"
sidebarTitle: "AutoMapper Integration"
description: "Plug AutoMapper into ABP via AbpAutoMapperOptions, AbpAutoMapperConfigurationContext, AutoMapperAutoObjectMappingProvider and per-module IObjectMapper context."
---
...
- [/data/object-extensions](/data/object-extensions) — `AbpObjectExtendingModule` (a dependency) wires extra-property mapping after AutoMapper passes.
