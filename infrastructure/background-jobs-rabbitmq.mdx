...
description: "RabbitMqBackgroundJobManager publishes to one queue per args type; delays use a dead-lettered delayed queue with x-message-ttl in Volo.Abp.BackgroundJobs.RabbitMQ."
---
