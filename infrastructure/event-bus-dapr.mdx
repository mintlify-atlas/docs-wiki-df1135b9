---
title: "Dapr Event Bus Provider: pub/sub Topics for ABP"
sidebarTitle: "Dapr"
description: "DaprDistributedEventBus uses a configurable PubSubName and one topic per event name; AbpDaprEventData carries MessageId, CorrelationId and the JSON ETO body."
---
