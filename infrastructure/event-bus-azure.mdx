---
title: "Azure Service Bus Event Bus Provider for ABP"
sidebarTitle: "Azure Service Bus"
description: "AzureDistributedEventBus uses a topic + subscription per service, Service Bus message Subject/MessageId/CorrelationId, and a PublisherPool for batched sends."
---
