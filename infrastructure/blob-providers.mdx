---
title: "BLOB providers: FileSystem, Azure, AWS, Aliyun, GCS, Minio"
sidebarTitle: "BLOB Providers"
description: "Catalog of ABP IBlobProvider packages with their options, naming normalizers and Use* extensions for plugging cloud storage backends into containers."
---
...
- [/multi-tenancy/aspnetcore-multitenancy](/multi-tenancy/aspnetcore-multitenancy) — how `IsMultiTenant` interacts with tenant context.
