...
sidebarTitle: "Rebus"
description: "RebusDistributedEventBus delegates to Rebus's IBus, exposes a Configurer hook for transport choice, and uses an Abp pipeline step to dedupe handler invocations."
---
