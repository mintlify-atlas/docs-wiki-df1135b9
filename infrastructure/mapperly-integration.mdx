...
description: "Replace runtime reflection with Mapperly source-generated mappers in ABP through MapperBase, IAbpMapperlyMapper, conventional registration and reverse maps."
---
...
- [/data/object-extensions](/data/object-extensions) — `ExtraProperties` that `MapExtraPropertiesAttribute` copies.
