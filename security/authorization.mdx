...
description: "Inside Volo.Abp.Authorization — how AuthorizationInterceptor, AbpAuthorizationPolicyProvider, and PermissionRequirementHandler turn attributes into checks."
---
