...
description: "Inside Volo.Abp.IdentityModel — how IdentityModelAuthenticationService caches OIDC discovery and access tokens to authenticate service-to-service HTTP clients."
---
