...
sidebarTitle: "LDAP"
description: "Inside Volo.Abp.Ldap — how LdapManager performs LDAP/LDAPS simple-bind auth and ILdapSettingProvider reads connection metadata from Volo.Abp.Settings."
---
