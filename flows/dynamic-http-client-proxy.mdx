---
title: "Dynamic HTTP Client Proxy: Interface Call to Remote Round-Trip"
sidebarTitle: "HTTP Client Proxy"
description: "Trace ABP Framework dynamic HTTP proxy from caller interface invocation through interceptor, configuration, client authentication, and remote MVC round-trip."
---
