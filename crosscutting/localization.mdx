...
description: "How ABP defines localization resources, loads them via virtual-file contributors, exposes them as IStringLocalizer, and pulls dynamic strings from an external store."
---
