...
description: "How AbpFluentValidationModule discovers IValidator<T> implementations and plugs them into the ABP validation pipeline through FluentObjectValidationContributor."
---
