...
The listing above is generated from a literal `ls npm/packs/` of the repository. The total currently sits at 54 directories plus the `npm-check-updates.ps1` helper script that bumps all dependency ranges in one pass.
