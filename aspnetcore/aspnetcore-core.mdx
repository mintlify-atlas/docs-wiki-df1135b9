...
description: "AbpAspNetCoreModule plus the middleware family (exception, UoW, auditing, correlation, security headers, localization) and the options that shape them."
---
