...
| `abp_io/` | `AbpIoLocalization.slnx` plus translation resources used by the abp.io website (not part of the framework) | n/a |
...
- **DDD root contracts** — `framework/src/Volo.Abp.Ddd.Domain/Volo/Abp/Domain/Entities/Entity.cs` and `framework/src/Volo.Abp.Ddd.Domain/Volo/Abp/Domain/Repositories/IRepository.cs`. Documented on [Entities and aggregates](/ddd/domain-entities-and-aggregates) and [Repositories](/ddd/domain-repositories).
