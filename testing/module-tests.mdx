...
| `feature-management` | 5 | TestBase, Domain.Tests, EntityFrameworkCore.Tests, MongoDB.Tests, HttpApi.Client.ConsoleTestApp |
| `permission-management` | 5 | TestBase, Domain.Tests, EntityFrameworkCore.Tests, MongoDB.Tests, HttpApi.Client.ConsoleTestApp |
| `tenant-management` | 5 | Same shape with Application.Tests |
| `blogging` | 5 | Domain + Application + persistence variants |
| `audit-logging` | 4 | TestBase, EntityFrameworkCore.Tests, MongoDB.Tests, plus one app/HttpApi |
| `background-jobs` | 4 | TestBase, EntityFrameworkCore.Tests, MongoDB.Tests, HttpApi.Client.ConsoleTestApp |
| `blob-storing-database` | 4 | TestBase + persistence variants |
| `openiddict` | 4 | Same shape |
| `identityserver` | 4 | Same shape |
| `setting-management` | 4 | TestBase + persistence variants |
| `basic-theme` | 3 | A single Tests project plus support |
| `account` | 1 | A single Web.Tests project |
