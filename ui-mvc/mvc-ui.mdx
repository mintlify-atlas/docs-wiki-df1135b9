---
title: "Volo.Abp.AspNetCore.Mvc.UI — Core Package Tour"
sidebarTitle: "MVC UI Core"
description: "Walks the Volo.Abp.AspNetCore.Mvc.UI package — module, theming abstractions, layouts, AbpPageModel, layout hooks, and alerts."
---
...
### `IThemeSelector` and `IThemeManager`
